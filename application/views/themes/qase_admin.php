...
<html lang="en">
    ...
    <!-- CSS -->
		<!--<link href="<?php echo base_url(); ?>assets/themes/qase/css/jquery-ui.min.css" rel="stylesheet">-->
    ...
    <link href="<?php echo base_url(); ?>assets/themes/qase/css/bootstrap.min.css" rel="stylesheet">
		...
		<link href="<?php echo base_url(); ?>assets/themes/qase/css/jquery.dataTables.min.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container">
      ...
      <footer>
		...
		<!--<script src="<?php echo base_url(); ?>assets/themes/qase/js/jquery-ui.min.js"></script>-->
		...
		<script src="<?php echo base_url(); ?>assets/themes/qase/js/jquery.dataTables.min.js"></script>
		<script>
