        ...
        <form id="course_form" data-toggle="validator" role="form" method="post">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="course_name" name="course_name" required="">
                    ...
                    <option value="<?php echo $value['code']; ?>" <?php echo isset($_POST['course_name']) && $_POST['course_name'] == $value['title'] ? 'selected' : $data->course_name == $value['title'] ? 'selected' : '';  ?>><?php echo $value['title']; ?></option>
                    <?php endforeach; ?>
                    <?php endif; ?>
                </select>
            </div>
