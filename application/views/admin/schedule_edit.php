        ...
        <form id="course_form" data-toggle="validator" role="form" method="post">
            <div class="form-group">
                ...
                <select class="form-control" id="course_year" name="course_year" required="">
                    ...
                    <option value="<?php echo $key ?>" <?php echo isset($data->course_year) && $data->course_year == $key ? 'selected' : '';  ?>><?php echo $value; ?></option>
                    <?php endforeach; ?>
                    <?php endif; ?>
                </select>
            </div>
            <div class="form-group">
                ...
                <select class="form-control" id="course_id" name="course_id" required="">
                    ...
                    <option value="<?php echo $key ?>" <?php echo isset($data->course_id) && $data->course_id == $key ? 'selected' : '';  ?>><?php echo $value; ?></option>
                    <?php endforeach; ?>
                    <?php endif; ?>
                </select>
            </div>
